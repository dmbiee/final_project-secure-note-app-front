...
const { notesQuery } = useNotes();
  ...
  return (
      ...
      <button onClick={() => AuthService.logout(navigate)} className='fixed w-10 h-10 transition-all duration-200 top-5 right-5 opacity-10 hover:opacity-40 hover:scale-105'> <img src="../../public/logout.svg" alt="" /></button>
      </div>
  )
}
